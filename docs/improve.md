...
* **A note on deprecation:**  Normally, for any kind of change of this magnitude, will has a deprecation notice and schedule, to give people time to upgrade.  However, because the nature of this problem is that the V2 token expires and will just silently dies without explanation, the decision was made to make this as a breaking change, with no deprecation schedule.  This is not, and will not, be the norm.  Thanks for hanging in there through the transition.
