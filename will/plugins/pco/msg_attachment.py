...
class SlackAttachment:
    ...
    def __init__(self,fallback="", pco="people",text="", button_color="people", action_type="button", button_text="Open in PCO", button_url=""):
        ...
        if pco == "people":
            ...
            self.footer_icon = "https://d1pz3w4vu41eda.cloudfront.net/assets/people/favicon-128-9da4ee8f3ce3ec27b9ae86cceb4f3bb5c4e58c2becf38bee6850ff3923415e50.png"
        if pco == "services":
            self.color = "#0e8a16"
        ...
        if pco == "groups":
            ...
            self.footer_icon = "https://d1hyrr5xjek6kh.cloudfront.net/assets/groups/favicon-128-72f00b4c20882e96fc4490129f73de2860e1444ec3b2800dfd0120c36322b7ab.png"
        if pco == "giving":
            self.color = "#f4c551"
            self.button_color = "#f4c551"
            self.footer_icon = "https://d3pvtdriu5iusc.cloudfront.net/assets/giving/favicon-128-a70151fb5689841d8bd4f8fb64756c6421aae8d2076cbf656b46626175a38125.png"
